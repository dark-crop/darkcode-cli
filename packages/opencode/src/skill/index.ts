...
const BROWSER_SKILL_BODY = [
  ...
  "",
  "Screenshots: prefer a VIEWPORT screenshot (what is on screen now) over a full-page one. Full-page",
  "captures of long pages get downscaled to fit the model's vision limit, which softens small text -",
  "scroll and take another viewport shot to read more, instead of one giant full-page capture.",
  "",
