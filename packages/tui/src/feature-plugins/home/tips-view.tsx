...
const TIPS: Tip[] = [
  ...
  (shortcuts) => press(shortcuts.agentCycle(), "to cycle mode (manual, accept edits, plan, auto)"),
  ...
  "Create a plugin to prevent Darkcode from reading sensitive files",
  "Use {highlight}darkcode run{/highlight} for non-interactive scripting",
  "Use {highlight}darkcode --continue{/highlight} to resume the last session",
  "Use {highlight}darkcode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}darkcode serve{/highlight} for headless API access to Darkcode",
  "Use {highlight}darkcode run --attach{/highlight} to connect to a running server",
  "Run {highlight}darkcode upgrade{/highlight} to update to the latest version",
  "Run {highlight}darkcode auth list{/highlight} to see all configured providers",
  "Run {highlight}darkcode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}darkcode github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}darkcode debug config{/highlight} to troubleshoot configuration",
